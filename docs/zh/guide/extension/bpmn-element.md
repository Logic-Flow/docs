...
LogicFlow 提供了[自定义节点](zh/guide/basic/node)和[自定义边](zh/guide/basic/edge), 可以实现满足 BPMN2.0 规范的节点和边。然后在使用[数据转换](../extension/adapter)将生成的数据转换为 Activiti 需要的格式。
...
完整的 BPMN 案例工具请到[示例](zh/usage/bpmn)中体验。
