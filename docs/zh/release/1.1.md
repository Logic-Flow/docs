...
- features
  - 新增设置元素编辑、不可编辑状态 API。[setElementState](/api/graphModelApi.html#setelementstate)
  - 新增 API [lf.renderRawData](/api/logicFlowApi.html#renderrawdata)
- bugfix
...
- docs
  - 新增[group 插件](/guide/extension/component-group.md)
