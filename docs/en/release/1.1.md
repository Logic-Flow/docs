...
- features
  - 新增设置元素编辑、不可编辑状态 API。[setElementState](en/api/graphModelApi#setelementstate)
  - 新增 API [lf.renderRawData](en/api/logicFlowApi#renderrawdata)
- bugfix
...
- features
  ...
  - [节点缩放](en/guide/extension/extension-node-resize)插件支持设置放大缩小的最大最小值和调整灵敏度。
  - 新增[lf.fitView](en/api/logicFlowApi#fitview)方法 [@lixianyu-icon](https://github.com/lixianyu-icon)。
...
- docs
  ...
  - 新增[自定义插件教程](en/guide/extension/component-custom)
