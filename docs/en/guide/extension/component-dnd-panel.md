...
### Customizing the content of the drag-and-drop panel

**lf.setPatternItems(patternItems)**

**lf.extension.dndPanel.setPatternItems(patternItems)** Added in `1.1.0`.

Set the content of the drag-and-drop panel component.
