...
[详细 API](en/api/transformModelApi)

## editConfigModel

`属性`

页面编辑基本配置对象, 详情见[editConfigApi](en/api/editConfigModelApi)
...
[NodeModel](en/api/baseNodeModelApi) 或 [EdgeModel](en/api/baseEdgeModelApi)
...
[EdgeModel](en/api/baseEdgeModelApi) 或者 [NodeModel](en/api/baseNodeModelApi)
