...
import FlowControlPause from './bpmn-icon-flow-control-pause.svg';
import FlowControlPlay from './bpmn-icon-flow-control-play.svg';
import FlowControlStop from './bpmn-icon-flow-control-stop.svg';
import FlowControlRefresh from './bpmn-icon-flow-control-start.svg';
