 ...
 */
function toXmlJson(other?: ExtraPropsType) {
...
function convertLf2ProcessData(
  ...
  const xmlJsonData = toXmlJson(other)(data);
...
class BpmnAdapter {
  ...
  adapterOut = (data: any, other?: ExtraPropsType) => {
    ...
    if (other?.mapping?.out) {
      ...
      const nameMapping = (obj: any | any[]): any => {
        if (Array.isArray(obj)) {
...
BpmnAdapter.shapeConfigMap.set(BpmnElements.INTERMEDIATE_CATCH, {
  width: IntermediateEventConfig.width,
  height: IntermediateEventConfig.height,
});
BpmnAdapter.shapeConfigMap.set(BpmnElements.INTERMEDIATE_THROW, {
  width: IntermediateEventConfig.width,
  height: IntermediateEventConfig.height,
});
BpmnAdapter.shapeConfigMap.set(BpmnElements.BOUNDARY, {
  width: BoundaryEventConfig.width,
  height: BoundaryEventConfig.height,
});
BpmnAdapter.shapeConfigMap.set(BpmnElements.PARALLEL_GATEWAY, {
  width: ParallelGatewayConfig.width,
  height: ParallelGatewayConfig.height,
});
BpmnAdapter.shapeConfigMap.set(BpmnElements.INCLUSIVE_GATEWAY, {
  width: InclusiveGatewayConfig.width,
  height: InclusiveGatewayConfig.height,
});
BpmnAdapter.shapeConfigMap.set(BpmnElements.EXCLUSIVE_GATEWAY, {
...
BpmnAdapter.shapeConfigMap.set(BpmnElements.SUBPROCESS, {
